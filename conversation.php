...
<body>
<span class="heading">Private Conversation</span><span style="float:right" style="margin:40px;"><a href="logout.php">
<img src="images/logout.png" height="50" width="100"  /></a></span>

<div align="center">
<form method="post" action="" style="margin: 5px;">
<table class="table" cellpadding="4" cellspacing="4" style="margin:70px;">
<tr><td class="tableHead" colspan="2" align="center" >Send Messages</td></tr>
<tr><td class="info" colspan="2" align="center"><?php echo $info;?></td></tr>
<tr><td class="labels">Select User : </td><td><select name="user" class="fields" style="background-color:white;">
...
<tr><td class="tableHead" align="center" colspan="2" style="text-decoration:underline; margin-top:1px;">Inbox</td></tr>
...
<span style="color:red;"> ( From <?php echo $recv;?> on <?php echo $t['date'];?>)</span>
</td><td><a href="deleteMessage.php?del=<?php echo $t['id'];?>" style="font-size:12px;color:black;">Delete</a></td></tr>
<?php } ?>
...
<?php while($t=mysqli_fetch_array($r))
{
	...
	$recv=$p['nick'];
	?>
<tr><td class="msg" style="font-size:12px;"><?php echo $t['msg'];?><span style="color:#F39;"> ( To <?php echo $recv;?> on <?php echo $t['date'];?>)</span></td><td><a href="deleteMessage.php?del=<?php echo $t['id'];?>" style="font-size:12px;color:black;">Delete</a></td></tr>
<?php } ?>
