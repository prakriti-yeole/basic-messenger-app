...
<body>
<span class="heading">Welcome Admin </span><span style="float:right"><a href="logout.php">
...
<a href="manageUsers.php" style="color:blue;text-decoration:underline;text-shadow:none;">Manage Users</a><br />
<br />
<a href="changePasswordAdmin.php" style="color:blue;text-decoration:underline;text-shadow:none;">Change Password</a>

<br />
<br />
<form method="post" action="">
<span class="tableHead" style="font-size:16px;text-decoration:none;color:red;">To Delete All Messages verify password  </span><br />
